...
// run runs our executable’s logic by:
// Creating the agent and handling signals from the operating system and shutting down 
// the agent gracefully when the operating system terminates the program
